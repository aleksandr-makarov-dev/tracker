...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "border-input px-3 py-1 text-sm h-8 rounded-md border bg-transparent flex w-fit items-center justify-between gap-2 whitespace-nowrap transition-colors outline-none disabled:cursor-not-allowed disabled:opacity-50",
